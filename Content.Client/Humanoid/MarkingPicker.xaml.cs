...
public sealed partial class MarkingPicker : Control
{
    ...
    public void SetHairMarking(Marking? marking) => HairMarking = marking;
    public void SetFacialHairMarking(Marking? marking) => FacialHairMarking = marking;
    ...
    public void SetSpecies(ProtoId<SpeciesPrototype> species)
    {
    ...
    public void SetProfile(ICharacterProfile? profile)
    {
        if (profile is not HumanoidCharacterProfile humanoid)
            return;

        SetData(humanoid.Appearance.Markings,
            humanoid.Species,
            humanoid.Sex,
            humanoid.Appearance.SkinColor,
            humanoid.Appearance.EyeColor);
    }
}
